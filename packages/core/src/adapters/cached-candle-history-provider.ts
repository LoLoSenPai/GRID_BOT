import type { CandleHistoryProvider, MarketCandleRepository } from "../domain/contracts";
import type { CandleHistoryRequest, CandleHistoryResult, NormalizedCandle } from "../domain/types";
